...
class wc_lottery {
	...
	private function define_public_hooks() {
            ...
            //$this->loader->add_action( 'woocommerce_product_is_visible', $this->plugin_public, 'filter_lottery', 10, 2 );
            $this->loader->add_action( 'woocommerce_before_shop_loop_item_title', $this->plugin_public, 'add_lottery_bage',60 );
            $this->loader->add_action( 'woocommerce_single_product_summary', $this->plugin_public, 'woocommerce_lottery_participate_template', 25 );
            $this->loader->add_action( 'woocommerce_single_product_summary', $this->plugin_public, 'woocommerce_lottery_winners', 25 );
            $this->loader->add_action( 'woocommerce_lottery_add_to_cart', $this->plugin_public, 'woocommerce_lottery_add_to_cart' );
