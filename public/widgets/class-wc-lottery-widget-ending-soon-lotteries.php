...
class WC_Lottery_Widget_Ending_Soon_Lotteries extends WP_Widget {
	...
	function __construct() {
		...
		$this->woo_widget_cssclass = 'woocommerce widget__ending_soon_lotteries';
		$this->woo_widget_description = __( 'Display a list of your ending soon lotteries on your site.', 'wc_lottery' );
		$this->woo_widget_idbase = 'woocommerce_ending_soon_lotteries';
		$this->woo_widget_name = __( 'WooCommerce Ending Soon lotteries', 'wc_lottery' );

		/* Widget settings. */
		$widget_ops = array( 'classname' => $this->woo_widget_cssclass, 'description' => $this->woo_widget_description );

		parent::__construct('ending_soon_lotteries', $this->woo_widget_name, $widget_ops);
	...
	function widget($args, $instance) {
		...
		$cache = wp_cache_get('widget_ending_soon_lotteries', 'widget');		
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Ending soon lotteries', 'wc_lottery' ) : $instance['title'], $instance, $this->id_base);
		...
		wp_cache_set('widget_ending_soon_lotteries', $cache, 'widget');
	}
	...
	function update( $new_instance, $old_instance ) {
		...
		if ( isset($alloptions['widget_ending_soon_lotteries']) ) delete_option('widget_ending_soon_lotteries');

		return $instance;
	}

	function flush_widget_cache() {
		wp_cache_delete('widget_ending_soon_lotteries', 'widget');
	}
